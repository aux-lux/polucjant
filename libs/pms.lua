local M={name=...,model=3,mlen=nil,stdATM=nil,verbose=nil,debug=nil,pm01=nil,pm25=nil,pm10=nil,psd=nil}
_G[M.name]=M
...
function M.read(callBack)
  ...
  assert(type(callBack)=='function' or callBack==nil,('%s.init %s argument should be %s'):format(M.name,'1st','function'))
